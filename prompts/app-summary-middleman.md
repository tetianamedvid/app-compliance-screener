...
What the app is for (one or two sentences). Base this only on the evidence.

**2. What is sold through the app (in detail)**
...
**3. What the end shopper gets by buying through the app (in detail)**
